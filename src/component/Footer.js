...
export default function Footer(){
  return(
    ...
    <div className={FooterStyle.main}>
      ...
      <div className={FooterStyle.copy} style={{display: "flex" , justifyContent : "center" ,border : "2px dotted white " ,backgroundColor :"lightblue" , color : "white"}}>
      <h3 >&copy;2023 All Rights  Reserved To Team 4</h3>
      </div>
    </>
  )
}